...
class LANISTRMultiModalForPreTrainingOutput(utils.ModelOutput):
  """LANISTR class for model's outputs."""

  loss: Optional[torch.FloatTensor] = None
  logits: Optional[torch.FloatTensor] = None
  loss_mlm: Optional[torch.FloatTensor] = None
  loss_mim: Optional[torch.FloatTensor] = None
  loss_mtm: Optional[torch.FloatTensor] = None
  loss_mfm: Optional[torch.FloatTensor] = None
  loss_mmm: Optional[torch.FloatTensor] = None


@dataclasses.dataclass
class BaseModelOutput(utils.ModelOutput):
